...
import App from './App'
import { fetchEpisodes as mockFetchShow} from './api/fetchShow'
...
mockFetchShow.mockResolvedValue(EpiData);
...
test('render episodes when API is called', async () => {
      ...
      const click = screen.getByRole('button', {name: /select a season/i});
